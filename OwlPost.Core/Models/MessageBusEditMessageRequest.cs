...
public record MessageBusEditMessageRequest : IMessageBusRequest
{
    ...
    public void Deconstruct(out DateTime createdOn, out Guid createdBy, out string groupingKey, out string content, out Guid roomId, out Guid concurrencyToken, out Guid messageId)
    {
        createdOn = CreatedOn;
        createdBy = CreatedBy;
